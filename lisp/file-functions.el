...
(global-set-key (kbd "C-z s") 'show-file-name)
...
(global-set-key (kbd "C-z e") 'make-file-executable)
...
(global-set-key (kbd "C-z n") 'rename-file-and-buffer)
...
(global-set-key (kbd "C-z m") 'move-buffer-file)
